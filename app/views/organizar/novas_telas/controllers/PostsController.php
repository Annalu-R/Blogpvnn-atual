...
class PostsController{
    ...
    private function findAll(string $msg = null){
        ...
        $data['posts']     = $posts;
        $data['base_path'] = "http://localhost:8080/dw/views/admin";

        $this->loadView("posts/posts.php", $data);
    ...
    private function deleteByIdPost(){
        $idParam = $_GET['idPosts'];
        $postsRepository = new PostsRepository();    
    ...
    private function edit(){
        ...
        $this->loadView("forms/posts/formEditaPosts.php", $data);
    }
