...
//print_r ($_POST["nome"]);
    ...
    private function loadFormNew(){
        $this->loadView("forms/categories/formCadastroCategory.php", null,"teste");
    }    
    ...
    private function findAll(string $msg = null){
        ...
        $this->loadView("forms/categories/Categorylist.php", $data, $msg);
    }
    ...
    private function edit(){
        ...
        $this->loadView("forms/categories/formEditaCategory.php", $data);
    }
