...
//print_r ($_POST["nome"]);
    ...
    private function loadFormNew(){
        $this->loadView("forms/users/formCadastroUser.php", null,"teste");
    }    
    ...
    private function findAll(string $msg = null){
        ...
        $this->loadView("forms/users/Userlist.php", $data, $msg);
    }
    ...
    private function edit(){
        ...
        $this->loadView("forms/users/formEditaUser.php", $data);
    }
